...
public interface JazzyEffect {
     ...
     * 初始化这个View的属性，所以这个view的位置是在动画开始之前
     * @param item The view to be animated.	参数1：item视图
     * @param position The index of the view in the list.这个view所在list中的位置
     * @param scrollDirection Positive number indicating scrolling down, or negative number indicating scrolling up.
    		滚动方向要求为正数，向下滚动 负数表示向上滚动
     */
