...
public class ModifyOffset {
	...
	//获取偏移纠正后的经纬度
	public static String jingweidu(double x,double y) {
		try {
			ModifyOffset offset = ModifyOffset.getInstance(ModifyOffset.class.getResourceAsStream("axisoffset.dat"));
			
			PointDouble c2s = offset.c2s(new PointDouble(x, y));//标准坐标转换为火星坐标
