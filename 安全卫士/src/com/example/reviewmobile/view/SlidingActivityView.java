 ...
 * 
 */
public class SlidingActivityView extends HorizontalScrollView {
	...
	public SlidingActivityView(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//		float leftAlpha = 0.6f+0.4f*(1-scale);//menu透明度
		...
		//调用属性动画
		ViewHelper.setTranslationX(mMenu, mMenuWidth*scale);//抽屉式效果
